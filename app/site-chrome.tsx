  ...
  return (
    <header className="nav shell resource-nav">
      ...
      <nav aria-label="Primary navigation">
        <Link href="/job-fit-check">Job Fit Check</Link>
...
export function ResourceFooter() {
  return (
    <footer className="footer shell">
      <Brand />
      <div>
        <Link href="/job-fit-check">Job Fit Check</Link><Link href="/blog">Guides</Link><Link href="/free-ai-job-search-prompts">Free prompts</Link><Link href="/about">About</Link>
