  ...
  return (
    <header className="nav shell resource-nav">
      ...
      <nav aria-label="Primary navigation">
        <Link href="/job-fit-check">Resume Match Checker</Link>
...
export function ResourceFooter() {
  return (
    <footer className="footer shell">
      <Brand />
      <div>
        <Link href="/job-fit-check">Free Job Fit Checker</Link><Link href="/blog">Guides</Link><Link href="/free-ai-job-search-prompts">Free prompts</Link><Link href="/about">About</Link>
